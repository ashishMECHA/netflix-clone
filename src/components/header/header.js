    ...
    return(
        ...
        <div className='header-content'>
            <div className='header-billboard'>
                <img alt='billboard' src='https://occ-0-2482-3646.1.nflxso.net/dnm/api/v6/LmEnxtiAuzezXBjYXPuDgfZ4zZQ/AAAABcZdjcnDphK1TiPkNt19wMxyqql90YEzja-IMmQi9UeArdtQC1CC_yNRYPmTUlb6UXo4UlbH9SAPPZWwwzDdVEwmIRwFQCVAwYzcLP2jRu_p.webp?r=e02' />
            </div>
          ...
          <button className='header-button more-info_button'>
            <svg
              width='24'
              height='24'
              viewBox='0 0 24 24'
